...
class FileValidator:
    ...
    async def is_valid_file(self, file: UploadFile) -> bool:
        """
        Возвращает True, если сигнатура файла соответсвует типу файла, иначе - False
        :param file: Файл
        :return: True, есл файл валиден, иначе - False (Битый файл / Изменено расширение)
        """
        result: bool = False
        try:
            ...
            for signature in self.__SIGNATURES.get(file_extends):
